...
hitable_list *amodel() {
	...
	model *board = new model("board.obj", vec3(0, 1, 0), vec3(1, 1, 1), new lambertian(new constant_texture(vec3(0.4, 0.2, 0.1))));
	list[0] = board;
...
hitable_list *random_scene() {
	...
	//list[i++] = new model("board.obj", vec3(0, 1, 0), vec3(1, 1, 1), new lambertian(new constant_texture(vec3(0.4, 0.2, 0.1))));
